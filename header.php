							...
							if (!isset($_SESSION['logged_id'])) { 
								echo '<li class="li_property d-inline-block">
									   ...
									   echo '<li class="li_property d-inline-block">
										...
										echo '<li class="li_property d-inline-block">
										<button class="btn sell_button" data-toggle="modal" data-target="#profile">Profile</button>
										</li>';
							}
						 ?>
					</ul>
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupported">
		    <ul class="navbar-nav ml-auto">
		      ...
		      <li class="nav-item dropdown">
		        <a class="nav-link text-uppercase dropdown-toggle text-white" data-toggle="dropdown" href="#">Our Auctions</a>
		        <ul class="dropdown-menu">
		        	<li><a href="painting.php">painting</a></li>
		        	<li><a href="drawing.php">Drawing</a></li>
		        	<li><a href="carving.php">Carving</a></li>
		        	<li><a href="sculpture.php">Sculpture</a></li>
		        	<li><a href="photographic.php">Photography</a></li>
		        </ul>
		      </li>
		      <li class="nav-item">
