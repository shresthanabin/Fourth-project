...
<body>
	...
	<nav class="navbar navbar-expand-lg nav navbar-light bg-primary">
   		<div class="container">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupported">
		    <ul class="navbar-nav ml-auto">
		      ...
		      <li class="nav-item">
		        <a class="nav-link text-uppercase text-white" href="register.php">Register</a>
		      </li>
		      <li class="nav-item">
		        <a class="nav-link text-uppercase text-white" href="index.php">Login</a>
		      </li>
		    </ul>
		  </div>
		</div>
