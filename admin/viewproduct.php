      ...
      <div class="modal-content">
         ...
         <div class="modal-body" >
            ...
            <div class="form-group">
               ...
               <select class="px-2 mx-2" class="form-control" id="categoryId" name="categoryId" >
                  <?php 
                  require '../db.php';
      ...
      <div class="col-md-9 bg-secondary" >
         ...
         <table class="table table-striped table-dark table-auto text-center">
            ...
            <tbody>
            	<?php 
               require '../db.php';
               $stmt = $pdo->prepare("SELECT * FROM product ORDER BY id");
               $stmt->execute();
               foreach ($stmt as $row) { ?>
               <tr id="<?php echo $row['id']; ?>">
                  ...
                  <td data-target="categoryId"><?php echo $row['categoryId']; ?></td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      $(document).on('click', 'a[data-role=updates]',function(){
        ...
        var categoryId = $('#'+id).children('td[data-target=categoryId]').text();
    ...
    $('#saves').click(function(){
      ...
      $.ajax({
        url : 'connect.php',
        method : 'post',
        data : {lotnumber : lotnumber , names : names , seller : seller , description : description , price : price , productiondate : productiondate , auctiondate : auctiondate , categoryId : categoryId , types : types , drawing : drawing , item : item , dimension : dimension , material : material , weight : weight , used : used , imagetype : imagetype , feature : feature , id : id},
        success : function(response){
          ...
          $('#'+id).children('td[data-target=category]').text(categoryId);
