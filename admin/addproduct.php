...
header('location: index.php');
	...
	if (isset($_POST['submit'])) {
		...
		$sql = "INSERT INTO product (lotnumber, names, seller, description, price, productiondate, auctiondate, categoryId, types, drawing, item, dimension, material, weight, used, imagetype, feature, location, images) VALUES ( '$lotnumber', '$names', '$seller', '$description', '$price', '$productiondate', '$auctiondate', '$categoryId', '$types', '$drawing', '$item', '$dimension', '$material', '$weight', '$used', '$imagetype', '$feature', '$location', '$images')";
