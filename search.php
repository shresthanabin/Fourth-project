...
<div class="container py-3">
   ...
   <div class="row">
      ...
      <div class="col-md-4">
         ...
         <div class="row">
            <div class="col-md-6">
               <button class="btn btn-sm btn-success mb-3" type="button" data-toggle="modal" data-target="#details">More Details</button>
            </div>
            <div class="col-md-6 text-right">
               <button class="btn btn-sm btn-danger mb-3 px-3" type="button" data-toggle="modal" data-target="#bidding">Bidding</button>
            </div>
         </div>
      </div>
      <?php	}
